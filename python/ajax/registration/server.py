...
# CHECK FOR EMAIL ADDRESS AVAILABILITY IN REAL TIME (DO NOT ALLOW DUPLICATES)
@app.route("/user/emailCheck", methods=["POST"])
def emailCheck():
    print ("KEY UP IN EMAIL FIELD, CHECKING AGAINST DB")
    found=False
    ...
    if result:
        found = True
        print ("FOUND DUPLICATE EMAIL ADDRESS")
    else:
